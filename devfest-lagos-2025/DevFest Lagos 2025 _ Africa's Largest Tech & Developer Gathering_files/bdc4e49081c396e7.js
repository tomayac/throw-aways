(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    function U(e) {
      ...
      try {
        var u = JSON.parse(r, n._fromJSON),
          o = e.value;
        if (
          (null !== o && ((e.value = null), (e.reason = null), R(o, u)),
          null !== k)
        ) {
              ...
              if ('$' === o[0]) {
                ...
                switch (o[1]) {
                  case '$':
                    return o.slice(1);
                  case 'L':
                    return D((r = F(r, (n = parseInt(o.slice(2), 16)))));
                  case '@':
    ...
    function ea(e, t, r) {
      ...
      a.read()
        .then(function t(l) {
          var i = l.value;
          if (l.done) r || I(e, Error('Connection closed.'));
          else {
            var c = 0,
              d = o._rowState;
            l = o._rowID;
            for (
              ...
              if (-1 < y)
                ((function (e, t, r, n, o) {
                  switch (r) {
                    case 65:
                      ...
                      return;
                    case 79:
                      eu(e, t, n, o, Int8Array, 1);
                      return;
                    case 111:
                      Q(e, t, 0 === n.length ? o : en(n, o));
                      return;
                    case 85:
                      eu(e, t, n, o, Uint8ClampedArray, 1);
                      return;
                    case 83:
                      eu(e, t, n, o, Int16Array, 2);
                      return;
                    case 115:
                      eu(e, t, n, o, Uint16Array, 2);
                      return;
                    case 76:
                      eu(e, t, n, o, Int32Array, 4);
                      return;
                    case 108:
                      eu(e, t, n, o, Uint32Array, 4);
                      return;
                    case 71:
                      eu(e, t, n, o, Float32Array, 4);
                      return;
                    case 103:
                      eu(e, t, n, o, Float64Array, 8);
                      return;
                    case 77:
                      eu(e, t, n, o, BigInt64Array, 8);
                      return;
                    case 109:
                      eu(e, t, n, o, BigUint64Array, 8);
                      return;
                    case 86:
                      eu(e, t, n, o, DataView, 1);
                      return;
                  }
                  for (
                    var a = e._stringDecoder, l = '', i = 0;
                    i < n.length;
                    i++
                  )
                    l += a.decode(n[i], u);
                  switch (((n = l += a.decode(o)), r)) {
                    case 73:
                      ...
                      if ((p = s(_))) {
                        ...
                        v
                          ? N(c, v, _)
                          : h.set(d, new E('resolved_module', _, null));
                      break;
                    case 72:
                      switch (
                        ((t = n[0]),
                    ...
                    case 69:
                      ((o = (r = e._chunks).get(t)),
                        ...
                        o ? P(e, o, a) : r.set(t, new E('rejected', null, a)));
                      break;
                    case 84:
                ...
                })(e, l, p, v, (h = new Uint8Array(i.buffer, b, y - c))),
                  (c = y),
                  3 === d && c++,
                  (h = l = p = d = 0),
                  (v.length = 0));
                  ...
                  case p:
                    ...
                    try {
                      var A = j(P),
                        M = i++,
                        N = l(A, M);
                      return (c.append('' + M, N), '$' + M.toString(16));
                    } catch (e) {
                      if (
                        'object' == typeof e &&
                        null !== e &&
                      ...
                      return (
                        ...
                        r.read().then(function e(i) {
                          if (i.done) (o.append(t + l, 'C'), 0 == --s && n(o));
                            ...
                            try {
                              var c = JSON.stringify(i.value, a);
                              (o.append(t + l, c), r.read().then(e, u));
                            } catch (e) {
                              u(e);
                            }
                        }, u),
                ...
                if ('function' == typeof (e = E[v]))
                  return (
                    ...
                    S.next().then(function e(r) {
                      if (r.done) {
                        if (void 0 === r.value) w.append(t + T, 'C');
                        else
                          try {
                        ...
                        try {
                          ...
                          (w.append(t + T, l), S.next().then(e, u));
                        } catch (e) {
                          u(e);
                        }
                    }, u),
    ...
    function o() {
      return !(function () {
        if ('undefined' == typeof window) {
          let { workUnitAsyncStorage: t } = e.r(79392),
            r = t.getStore();
          if (!r) return !1;
          switch (r.type) {
            case 'prerender':
  ...
  (e, t, r) => {
    ...
    function i(e) {
      return u.test(e) ? 'dom' : a(e) ? 'html' : void 0;
    }
  },
  77242,
  (e, t, r) => {
    ...
    let i = e.r(21060),
      ...
      c =
        'undefined' != typeof window &&
        (0, s.isBot)(window.navigator.userAgent);
  ...
  (e, t, r) => {
    ...
    async function v(e, t) {
      ...
      (o === l.PrefetchKind.AUTO && (a[u.NEXT_ROUTER_PREFETCH_HEADER] = '1'),
        n && (a[u.NEXT_URL] = n));
      try {
        var c;
        let t = o ? (o === l.PrefetchKind.TEMPORARY ? 'high' : 'low') : 'auto',
          r = await _(e, a, t, h.signal),
        ...
        if (!v.startsWith(u.RSC_CONTENT_TYPE_HEADER) || !r.ok || !r.body)
        ...
        let O = g
            ...
            : r.body,
          R = await y(O);
        if ((0, s.getAppBuildId)() !== R.b) return p(r.url);
        return {
  ...
  (e, t, r) => {
    ...
    let n = e.r(39055),
      ...
      a = u[n.VIEWPORT_BOUNDARY_NAME.slice(0)],
      l = u[n.OUTLET_BOUNDARY_NAME.slice(0)],
