(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    let n = (0, e.r(85402).createAsyncLocalStorage)();
  },
  64650,
  (e, t, r) => {
    'use strict';
    ...
    function l(e, t) {
      if (e.dev)
        switch (t.type) {
          ...
          case 'request':
            var r;
            return null == (r = t.cookies.get(o.NEXT_HMR_REFRESH_HASH_COOKIE))
              ? void 0
              : r.value;
        }
    }
  ...
  (e, t, r) => {
    ...
    let n = e.r(84033)._(e.r(22446)),
      ...
      c = n.default.createContext(null),
  ...
  (e, t, r) => {
    ...
    let n = e.r(48355),
      o = e.r(41924),
      u = 'undefined' == typeof window ? e.r(71094).actionAsyncStorage : void 0;
    function a(e, t, r) {
      ...
      return (
        (u.digest = o.REDIRECT_ERROR_CODE + ';' + t + ';' + e + ';' + r + ';'),
        u
      );
    }
    function c(e, t) {
  ...
  (e, t, r) => {
    ...
    let n = '' + e.r(74535).HTTP_ERROR_FALLBACK_ERROR_CODE + ';404';
    function o() {
  ...
  (e, t, r) => {
    ...
    (Object.defineProperty(r, '__esModule', { value: !0 }),
      ...
      e.r(74535).HTTP_ERROR_FALLBACK_ERROR_CODE,
      ('function' == typeof r.default ||
        ('object' == typeof r.default && null !== r.default)) &&
        void 0 === r.default.__esModule &&
        (Object.defineProperty(r.default, '__esModule', { value: !0 }),
  ...
  (e, t, r) => {
    ...
    function E(e, t, r) {
      ...
      if (!e.forceDynamic && !e.forceStatic) {
        ...
        if (t)
          switch (t.type) {
            case 'prerender-ppr':
              return S(e.route, r, t.dynamicTracking);
            case 'prerender-legacy':
              t.revalidate = 0;
      ...
      return (
        e.abort(
          Object.defineProperty(
            new d.BailoutToCSRError('Render in Browser'),
            '__NEXT_ERROR_CODE',
      ...
      switch (e.type) {
        ...
        case 'prerender-runtime':
          ...
          if (e.cacheSignal)
            ...
            r
              ? r.then(() => (0, l.scheduleOnNextTick)(() => t.abort()))
    ...
    function B(e) {
      let t = c.workAsyncStorage.getStore(),
        ...
        switch (r.type) {
          ...
          case 'prerender': {
            ...
            o &&
              o.size > 0 &&
              n.default.use(
                (0, i.makeHangingPromise)(r.renderSignal, t.route, e)
              );
            break;
          }
          case 'prerender-ppr': {
            let n = r.fallbackRouteParams;
            if (n && n.size > 0) return S(t.route, e, r.dynamicTracking);
            break;
          }
          case 'prerender-runtime':
            throw Object.defineProperty(
    ...
    let X = /\n\s+at Suspense \(<anonymous>\)/,
      F = new RegExp(
        '\\n\\s+at Suspense \\(<anonymous>\\)(?:(?!\\n\\s+at (?:'
          ...
          .concat(s.ROOT_LAYOUT_BOUNDARY_NAME, ' \\([^\\n]*\\)')
      ),
    ...
    function V(e, t, r, n) {
      if (0 !== t) {
        ...
        if (n.syncDynamicErrorWithStack)
          throw (
            K(e, n.syncDynamicErrorWithStack),
            new u.StaticGenBailoutError()
          );
        ...
        get: function () {
          return function e(t) {
            if (
              ...
              (0, i.isDynamicServerError)(t) ||
              (0, c.isDynamicPostpone)(t) ||
              (0, o.isPostpone)(t) ||
  ...
  (e, t, r) => {
    ...
    let n =
      'undefined' == typeof window
        ? e.r(13534).unstable_rethrow
        : e.r(99583).unstable_rethrow;
    ('function' == typeof r.default ||
      ('object' == typeof r.default && null !== r.default)) &&
      void 0 === r.default.__esModule &&
      (Object.defineProperty(r.default, '__esModule', { value: !0 }),
  ...
  (e, t, r) => {
    ...
    let n = e.r(22446),
      ...
      d =
        'undefined' == typeof window
          ? e.r(76754).useDynamicRouteParams
          : void 0;
    function f() {
      let t = (0, n.useContext)(u.SearchParamsContext),
        r = (0, n.useMemo)(
          () => (t ? new i.ReadonlyURLSearchParams(t) : null),
          [t]
        );
      if ('undefined' == typeof window) {
        let { bailoutToClientRendering: t } = e.r(79769);
        t('useSearchParams()');
      }
      return r;
    }
    ...
    function b(e) {
      ...
      return t
        ? (function e(t, r, n, o) {
            ...
            if (!u) return o;
            let s = u[0],
              l = (0, a.getSegmentValue)(s);
            return !l || l.startsWith(c.PAGE_SEGMENT_KEY)
              ? o
              : (o.push(l), e(u, r, !1, o));
          })(t.parentTree, e)
        : null;
    ...
    function E(e) {
      (void 0 === e && (e = 'children'),
        null == d || d('useSelectedLayoutSegment()'));
      let t = b(e);
